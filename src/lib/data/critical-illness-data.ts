...
export const HIGH_INCIDENCE_DISEASES = [
  ...
  },
  {
    ...
    claimsShare: "老年退化性疾病",
    // 详细理赔标准
    severeCriteria: "满足以下任一条件：(1)日常生活（穿衣、如厕、移动、进食、洗澡、行动）6项中无法完成3项或以上，需要持续他人监护；(2)MMSE<10分（满分30分）。",
  ...
  },
  {
    ...
    claimsShare: "老年退化性疾病",
    // 详细理赔标准
    severeCriteria: "必须满足：(1)无法通过药物控制症状；(2)日常生活6项中无法完成3项或以上（穿衣、如厕、移动、进食、洗澡、行动）。",
    earlyCriteria: "安盛中度严重（非严重）：只需无法完成2项ADL即可获赔20%。",
